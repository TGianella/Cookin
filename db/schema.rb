...
ActiveRecord::Schema[7.0].define(version: 2023_03_29_125340) do
  ...
  create_table "categories_masterclasses", id: false, force: :cascade do |t|
    t.bigint "masterclass_id", null: false
